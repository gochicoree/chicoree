...
>
> Current revision: `2026-09-06.4` · [Changelog](#changelog) · index: `GET https://registry.example.com/api/v1` · in the app: `/docs/api`
...
- Every response carries `X-Api-Version: 1` and `X-Api-Revision: 2026-09-06.4`, and `Cache-Control: private, no-store`.
