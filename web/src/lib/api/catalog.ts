...
const WEBHOOK_BODY: ApiParam[] = [
  ...
  { name: "format", in: "body", type: "json | none | slack | discord | teams | text", description: "Payload shape; default json. `none` sends no body at all — the request, its headers and authentication are the signal (deploy hooks such as Coolify's, which read parameters from the URL and would misread the payload)." },
