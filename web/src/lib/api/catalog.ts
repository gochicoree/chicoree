...
export const API_CATALOG: ApiEndpoint[] = [
  // --- General ------------------------------------------------------------
  {
    ...
    example: {
      ...
      build: { version: "0.1.5", commit: "364d6d4" },
  ...
  {
    method: "GET",
    path: "/repos/{org}/{repo}/size-history",
    group: "Repositories",
    summary: "Image size over time",
    description: "For each of the last `days` days, the compressed size (layers + config) of the newest image pushed that day, zero when nothing was pushed. Indexes, referrers and attached artifacts are left out.",
    access: "public",
    serviceAccounts: true,
    params: [ORG_PARAM, REPO_PARAM, { name: "days", in: "query", type: "integer", description: "7–366; default 90." }],
    example: {
      days: 90,
      items: [
        { day: "2026-09-05", bytes: 0, digest: null },
        { day: "2026-09-06", bytes: 73400320, digest: "sha256:9f8e…" },
      ],
      latest: { day: "2026-09-06", bytes: 73400320, digest: "sha256:9f8e…" },
      peakBytes: 81920000,
    },
    since: "2026-09-07.1",
  },
  {
    method: "GET",
    path: "/repos/{org}/{repo}/access",
    group: "Repositories",
    summary: "Who has access to a repository",
    description: "The grants on this repository — per person or per team, on top of the organization roles — and what the caller may do here. Repository admins only.",
    access: "manager",
    params: [ORG_PARAM, REPO_PARAM],
    example: { items: [{ id: "g_91…", subjectType: "team", subjectId: "t_3a…", name: "Backend", detail: "backend", permission: "push", createdAt: "2026-09-07T09:10:00.000Z" }], total: 1, you: { role: "admin", manage: true, write: true, delete: true } },
    since: "2026-09-07.1",
  },
  {
    method: "PUT",
    path: "/repos/{org}/{repo}/access/{subjectType}/{subjectId}",
    group: "Repositories",
    summary: "Grant access to a person or a team",
    description: "`subjectType` is `user` or `team`. The grant raises what they may do in this repository above their organization role; it never lowers it. Members of the organization only.",
    access: "manager",
    write: true,
    params: [
      ORG_PARAM,
      REPO_PARAM,
      { name: "subjectType", in: "path", type: "user | team", required: true, description: "Whether `subjectId` is a user id or a team id." },
      { name: "subjectId", in: "path", type: "string", required: true, description: "User id or team id." },
      { name: "permission", in: "body", type: "pull | push | admin", required: true, description: "pull: browse and pull. push: also push, retag, copy in. admin: also delete images, change settings, manage access." },
    ],
    example: { id: "g_91…", subjectType: "team", subjectId: "t_3a…", name: "Backend", detail: "backend", permission: "push", createdAt: "2026-09-07T09:10:00.000Z" },
    since: "2026-09-07.1",
  },
  {
    method: "DELETE",
    ...
    access: "manager",
    write: true,
    params: [ORG_PARAM, REPO_PARAM, { name: "subjectType", in: "path", type: "user | team", required: true, description: "Whether `subjectId` is a user id or a team id." }, { name: "subjectId", in: "path", type: "string", required: true, description: "User id or team id." }],
  ...
  },
  {
    ...
    group: "Organizations",
    summary: "List teams",
    description: "Teams group members so a repository can grant access to all of them at once.",
    access: "member",
    params: [ORG_PARAM],
    example: { items: [{ id: "t_3a…", slug: "backend", name: "Backend", description: "Owns the API and the workers", memberCount: 3, createdAt: "2026-09-07T09:00:00.000Z" }], total: 1 },
    since: "2026-09-07.1",
  },
  {
    method: "POST",
    ...
    params: [
      ORG_PARAM,
      { name: "name", in: "body", type: "string", required: true, description: "Up to 64 characters." },
      { name: "slug", in: "body", type: "string", description: "Lowercase letters, digits and single . _ - separators; derived from the name when omitted." },
      { name: "description", in: "body", type: "string", description: "Up to 200 characters." },
    ],
    example: { id: "t_3a…", slug: "backend", name: "Backend", description: "Owns the API and the workers", memberCount: 3, createdAt: "2026-09-07T09:00:00.000Z" },
    since: "2026-09-07.1",
  },
  {
    method: "GET",
    ...
    description: "By slug or id, with the members.",
    access: "member",
    params: [ORG_PARAM, { name: "team", in: "path", type: "string", required: true, description: "Team slug or id." }],
    example: { id: "t_3a…", slug: "backend", name: "Backend", description: "Owns the API and the workers", memberCount: 1, createdAt: "2026-09-07T09:00:00.000Z", members: [{ userId: "u_7f…", name: "Jo Doe", email: "jo@example.com", role: "viewer", addedAt: "2026-09-07T09:05:00.000Z" }] },
    since: "2026-09-07.1",
  },
  {
    method: "PATCH",
    ...
    params: [
      ORG_PARAM,
      { name: "team", in: "path", type: "string", required: true, description: "Team slug or id." },
      { name: "name", in: "body", type: "string", description: "Up to 64 characters." },
      { name: "slug", in: "body", type: "string", description: "Lowercase letters, digits and single . _ - separators." },
      { name: "description", in: "body", type: "string", description: "Up to 200 characters." },
    ],
    example: { id: "t_3a…", slug: "backend", name: "Backend", description: "Owns the API and the workers", memberCount: 1, createdAt: "2026-09-07T09:00:00.000Z", members: [{ userId: "u_7f…", name: "Jo Doe", email: "jo@example.com", role: "viewer", addedAt: "2026-09-07T09:05:00.000Z" }] },
    since: "2026-09-07.1",
  },
  {
    ...
    description: "Its repository grants go with it; nobody loses their organization membership.",
    access: "manager",
    write: true,
    params: [ORG_PARAM, { name: "team", in: "path", type: "string", required: true, description: "Team slug or id." }],
    example: { deleted: true, team: "backend" },
    since: "2026-09-07.1",
  },
  {
    method: "GET",
    ...
    access: "member",
    params: [ORG_PARAM, { name: "team", in: "path", type: "string", required: true, description: "Team slug or id." }],
    example: { items: [{ userId: "u_7f…", name: "Jo Doe", email: "jo@example.com", role: "viewer", addedAt: "2026-09-07T09:05:00.000Z" }], total: 1 },
    since: "2026-09-07.1",
  },
  {
    method: "PUT",
    path: "/orgs/{org}/teams/{team}/members/{userId}",
    group: "Organizations",
    summary: "Add a member to a team",
    description: "Only members of the organization can join its teams (`GET /orgs/{org}/members` for their ids).",
    access: "manager",
    write: true,
    params: [ORG_PARAM, { name: "team", in: "path", type: "string", required: true, description: "Team slug or id." }, { name: "userId", in: "path", type: "string", required: true, description: "The member's user id." }],
    example: { id: "t_3a…", slug: "backend", name: "Backend", description: "Owns the API and the workers", memberCount: 1, createdAt: "2026-09-07T09:00:00.000Z", members: [{ userId: "u_7f…", name: "Jo Doe", email: "jo@example.com", role: "viewer", addedAt: "2026-09-07T09:05:00.000Z" }] },
    since: "2026-09-07.1",
  },
  {
