...
const WEBHOOK_BODY: ApiParam[] = [
  ...
  { name: "method", in: "body", type: "GET | POST | PUT | PATCH", description: "JSON receivers only; chat formats always POST. GET sends no body — for receivers that act on the request itself, such as a deploy hook." },
